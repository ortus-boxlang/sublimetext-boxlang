...
def get_struct_context(view, position):
    ...
    previous_char_point = get_char_point_before_scope(
        view, position, "meta.struct-literal.boxlang"
    )
    if not view.match_selector(
        previous_char_point,
        "keyword.operator.assignment.binary.boxlang,punctuation.separator.key-value.boxlang",
    ):
        return context
    ...
    if not view.match_selector(
        previous_char_point, "meta.property,variable,meta.struct-literal.key.boxlang"
    ):
        return context
...
def get_tag_name(view, pos):
    ...
    tag_name_scope = (
        "entity.name.tag.boxlang, entity.name.tag.custom.boxlang, entity.name.tag.script.boxlang"
    )
...
def get_tag_attribute_name(view, pos):
    ...
    if view.match_selector(
        pos,
        "meta.tag entity.other.attribute-name.boxlang, meta.class.declaration.boxlang entity.other.attribute-name.boxlang",
    ):
    ...
    for scope in ["string.quoted", "string.unquoted"]:
        full_scope = (
            "meta.tag.boxlang "
            + scope
            + ", meta.tag.custom.boxlang "
            + scope
            + ", meta.tag.script.boxlang "
            + scope
            + ", meta.tag.script.bx.boxlang "
            + scope
    ...
    full_scope = [
        "meta.tag.boxlang punctuation.separator.key-value",
        "meta.tag.custom.boxlang punctuation.separator.key-value",
        "meta.tag.script.boxlang punctuation.separator.key-value",
        "meta.tag.script.bx.boxlang punctuation.separator.key-value",
        "meta.class.declaration.boxlang punctuation.separator.key-value",
    ]
...
def get_function(view, pt):
    ...
    function_name_scope = (
        "entity.name.function.boxlang,entity.name.function.constructor.boxlang"
    )
